...
void REAXFF_BOND::Calculate_Bond_Energy_And_Derivatives(
    int bond_numbers, int need_atom_energy, float* atom_energy)
{
    ...
    Launch_Device_Kernel(
        ...
        atom_type_numbers, d_bo_s, d_bo_pi, d_bo_pi2, d_dE_dBO_s,
        d_dE_dBO_pi, d_dE_dBO_pi2, need_atom_energy ? atom_energy : NULL,
        d_energy_sum);
}
